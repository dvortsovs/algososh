        ...
        const cycle = setInterval(() => {
            if (currentIndex < index + 1) {
                ...
                setTimeout(() => {
                    ...
                    listStateCopy[currentIndex - 1].tempItem = listStateCopy[currentIndex - 1].item
                    ...
                    <div className={styles.formIndex}>
                        <Input
                            ...
                            onChange={(e: ChangeEvent<HTMLInputElement>) => {
                                if (!(Number(e.target.value) < 0)) setInputIndex(e.target.value)
                            }}
                            value={inputIndex}
                        />
                        <Button
                                ...
                                return (
                                    <li data-testid="listItem" className={styles.listItem} key={index}>
                                        <div className={`${item.addProgress
                                            ...
                                            : `${styles.topCircle}`}`}>
                                            <Circle isSmall={true} letter={item.tempItem} state={ElementStates.Changing}
                                            />
                                        </div>
                                        ...
                                        <div className={`${item.deleteProgress
